...
const doctors = [
  ...
  },
  {
    ...
    bio: { en: 'Specialist in dental implants, impacted tooth extractions, cyst operations, and facial aesthetics including Botox and bichectomy.', tr: 'Diş implantı, gömülü diş çekimi, kist operasyonları ve Botox, bişektomi dahil yüz estetiği uzmanı.', el: 'Ειδικός σε εμφυτεύματα, εξαγωγές φρονιμιτών, κύστες και αισθητική προσώπου.', ru: 'Специалист по имплантатам, удалению ретинированных зубов, кистам и эстетике лица.', ar: 'متخصص في زراعة الأسنان وخلع الأسنان المنطمرة والكيسات وتجميل الوجه.', he: 'מומחה בשתלים, עקירות שיני בינה, ציסטות ואסתטיקת פנים.', fa: 'متخصص در ایمپلنت دندان، کشیدن دندان‌های نهفته، عملیات کیست و زیبایی صورت شامل بوتاکس و بیشکتومی.', de: 'Spezialist für Implantate, Weisheitszahnentfernung, Zysten und Gesichtsästhetik.' },
    initials: 'AT',
  },
  {
    ...
    bio: { en: 'The clinic\'s most experienced practitioner with 42 years of uninterrupted practice. Expert in complex canal cases and previously failed treatments.', tr: 'Kliniğin en deneyimli hekimi, 42 yıllık kesintisiz klinik pratik. Kompleks kanal vakaları ve başarısız tedavi revizyonlarında uzman.', el: 'Ο πιο έμπειρος κλινικός ιατρός της κλινικής με 42 χρόνια αδιάκοπης πρακτικής.', ru: 'Самый опытный врач клиники с 42 годами непрерывной практики.', ar: 'الطبيب الأكثر خبرة في العيادة مع 42 عاماً من الممارسة المتواصلة.', he: 'הרופא המנוסה ביותר במרפאה עם 42 שנות עבודה רצופות.', fa: 'باتجربه‌ترین پزشک کلینیک با ۴۲ سال فعالیت بی‌وقفه. متخصص در موارد پیچیده کانال و درمان‌های ناموفق قبلی.', de: 'Der erfahrenste Arzt der Klinik mit 42 Jahren ununterbrochener Praxis.' },
    initials: 'RD',
  },
  {
  ...
  },
  {
    ...
    bio: { en: 'International background provides advantage in understanding multicultural patients. Strong advocate of preventive dentistry with regular six-monthly check-ups.', tr: 'Uluslararası geçmişi, farklı kültürlerden hastaları anlama konusunda önemli avantaj sağlar. Altı aylık periyodik kontrolleri savunan koruyucu diş hekimliği yaklaşımı.', el: 'Το διεθνές υπόβαθρο προσφέρει πλεονέκτημα στην κατανόηση πολυπολιτισμικών ασθενών.', ru: 'Международный опыт даёт преимущество в работе с пациентами разных культур.', ar: 'الخلفية الدولية تمنح ميزة في فهم المرضى من ثقافات مختلفة.', he: 'הרקע הבינלאומי מעניק יתרון בהבנת מטופלים מתרבויות שונות.', fa: 'پیشینه بین‌المللی مزیتی در درک بیماران چندفرهنگی فراهم می‌کند. مدافع قوی دندانپزشکی پیشگیرانه با معاینات دوره‌ای شش‌ماهه.', de: 'Internationaler Hintergrund bietet Vorteil im Umgang mit multikulturellen Patienten.' },
    initials: 'AZ',
  },
];
